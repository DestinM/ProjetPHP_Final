...
-->
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a href="academique.php"><i class="fa fa-graduation-cap" aria-hidden="true"></i>Anne
                                Academique</a>
                        </li>
                        <li>
...
<div class="modal fade" id="edit" tabindex="-1" role="dialog" aria-labelledby="edit" aria-hidden="true">
    <div class="modal-dialog">
                        ...
                        <select id="matiere" name="matiere">
                            ...
                            if (count($resultNew > 0)) {
                                foreach ($resultNew as $index => $row) { ?>
                                    <option
                                        value="<?php echo $row['Matiere_Name']; ?>"><?php echo $row['Matiere_Name']; ?></option>
                                <?php }
        ...
        <div class="modal-footer ">
            <button onclick="$('#bulletinForm').submit();" type="button" class="btn btn-warning btn-lg"
                    style="width: 100%;"><span class="glyphicon glyphicon-ok-sign">
        </span> enregistrer
            </button>
        </div>
    </div>
