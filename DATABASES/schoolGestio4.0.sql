...
--
-- Host: localhost
-- Generation Time: Jun 14, 2017 at 12:46 
...
INSERT INTO `etudiant` (`Code_Etudiant`, `Nom`, `Prenom`, `Sexe`, `Date_Naiss`, `Email`, `vacation`, `classe`, `domaine`, `annee_academique`) VALUES
...
(26, 'lksjdf', 'lskdjflk', 'masculin', 'lskjdflk', 'lsdkjfl', 'soir', 'propedeutique', 'sldkfjl', 'lskdfjl'),
(27, 'lksjdf', 'lskdjflk', 'masculin', 'lskjdflk', 'lsdkjfl', 'soir', 'propedeutique', 'sldkfjl', 'lskdfjl'),
(28, 'moise', 'destin', 'masculin', 'lskdjfl', 'lskdjf', 'matin', 'propedeutique', 'lsdlfkjs', 'sldfkjsf');
...
INSERT INTO `etudiant_note` (`matiere`, `note`, `id`, `id_etudiant`) VALUES
('DAANA', '34', 1, NULL),
('adsfadsfa', '50', 2, 1),
('matiere', '', 3, 1),
('matiere', '2323432', 4, 1),
...
--
ALTER TABLE `etudiant`
  MODIFY `Code_Etudiant` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
--
...
--
ALTER TABLE `matiere`
  MODIFY `Matiere_Code` mediumint(9) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
